...
cp train_cleaned_segm+norm/* train_cleaned_segm+norm+lemmat/
perl -i -pe "s/^.*\t(.+)$/\1/g" train_cleaned_segm+norm+lemmat/*.tokenized-pie.txt
perl -i -pe "s/\n/ /g"  train_cleaned_segm+norm+lemmat/*.tokenized-pie.txt
perl -i -pe "s/normalised //g"  train_cleaned_segm+norm+lemmat/*.tokenized-pie.txt
~/pie-extended/env/bin/pie-extended tag fro train_cleaned_segm+norm+lemmat/*tokenized-pie.txt
cp train_cleaned_segm+norm+lemmat/*-pie-pie.txt train_lemmas/
